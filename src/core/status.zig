...
pub const Status = enum(i32) {
    ...
    // Fee errors
    INVALID_FEE_FILE = 90,
    EXCHANGE_RATE_CHANGE_LIMIT_EXCEEDED = 91,
    MAX_CONTRACT_STORAGE_EXCEEDED = 92,
    TRANSFER_ACCOUNT_SAME_AS_DELETE_ACCOUNT = 93,
    TOTAL_LEDGER_BALANCE_INVALID = 94,
    EXPIRATION_REDUCTION_NOT_ALLOWED = 95,
    MAX_GAS_LIMIT_EXCEEDED = 96,
    MAX_FILE_SIZE_EXCEEDED = 97,
    RECEIVER_SIG_REQUIRED = 98,
    
    // Scheduled transaction errors
    ...
    pub fn fromInt(value: i32) !Self {
        return std.meta.intToEnum(Self, value) catch error.InvalidStatus;
    }
