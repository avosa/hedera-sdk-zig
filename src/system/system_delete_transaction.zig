...
pub const SystemDeleteTransaction = struct {
    ...
    pub fn setContractId(self: *SystemDeleteTransaction, contract_id: ContractId) !void {
    ...
    pub fn setFileId(self: *SystemDeleteTransaction, file_id: FileId) !void {
        if (self.base.frozen) return error.TransactionIsFrozen;
    ...
    pub fn setExpirationTime(self: *SystemDeleteTransaction, expiration_time: Timestamp) !void {
        if (self.base.frozen) return error.TransactionIsFrozen;
